...
class MultiPartParser:
    ...
    def handle_file_complete(self, old_field_name: str,
...
class LazyStream:
    ...
    position: int = ...
    def __init__(
        self, producer: Union[BoundaryIter, ChunkIter], length: None = ...) -> None: ...
...
class Parser:
    def __init__(self, stream: LazyStream, boundary: bytes) -> None: ...
    def __iter__(self) -> Iterator[Tuple[str, Dict[str,
                                                   Tuple[str, Dict[str, Union[bytes, str]]]], LazyStream]]: ...
