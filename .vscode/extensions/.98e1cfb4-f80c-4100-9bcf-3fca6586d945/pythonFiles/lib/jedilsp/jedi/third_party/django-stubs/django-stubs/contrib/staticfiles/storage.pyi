...
class StaticFilesStorage(FileSystemStorage):
    ...
    def __init__(self, location: Optional[str] = ...,
                 base_url: None = ..., *args: Any, **kwargs: Any) -> None: ...
...
class HashedFilesMixin:
    ...
    def hashed_name(
        self, name: str, content: Optional[File] = ..., FILENAME: Optional[str] = ...) -> str: ...

    def url_converter(self, name: str, hashed_files: OrderedDict,
