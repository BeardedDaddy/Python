...
class FieldFile(File):
    ...
    def __init__(self, instance: Model, field: FileField,
...
class FileDescriptor:
    ...
    def __get__(self, instance: Optional[Model], cls: Type[Model]
...
class FileField(Field):
    ...
    def generate_FILENAME(
        self, instance: Optional[Model], FILENAME: str) -> str: ...
...
class ImageField(FileField):
    ...
    def update_dimension_fields(
        self, instance: Model, force: bool = ..., *args: Any, **kwargs: Any) -> None: ...
