...
class HttpResponseBase(Iterable[Any]):
    ...
    def __setitem__(
        self, header: Union[str, bytes], value: Union[str, bytes, int]) -> None: ...
    ...
    @overload
    def get(self, header: Union[str, bytes],
            alternate: Optional[str]) -> str: ...
    ...
    def set_signed_cookie(self, key: str, value: str,
                          salt: str = ..., **kwargs: Any) -> None: ...
...
class StreamingHttpResponse(HttpResponseBase):
    ...
    def __init__(
        self, streaming_content: Iterable[Any] = ..., *args: Any, **kwargs: Any) -> None: ...
...
class FileResponse(StreamingHttpResponse):
    ...
    as_attachment: bool = ...
    FILENAME: str = ...
    def __init__(self, *args: Any, as_attachment: bool = ...,
...
class HttpResponseRedirectBase(HttpResponse):
    ...
    def __init__(self, redirect_to: str, *args: Any,
                 **kwargs: Any) -> None: ...
...
class HttpResponseNotAllowed(HttpResponse):
    def __init__(
        self, permitted_methods: Iterable[str], *args: Any, **kwargs: Any) -> None: ...
