...
class CallableSettingWrapper:
    def __init__(
        self, callable_setting: Union[Callable, Type[Any]]) -> None: ...


def cleanse_setting(key: Union[int, str], value: Any) -> Any: ...
def get_safe_settings() -> Dict[str, Any]: ...
def technical_500_response(request: Any, exc_type: Any,
                           exc_value: Any, tb: Any, status_code: int = ...): ...
...
def get_exception_reporter_filter(
    request: Optional[HttpRequest]) -> ExceptionReporterFilter: ...
...
class SafeExceptionReporterFilter(ExceptionReporterFilter):
    ...
    def get_cleansed_multivaluedict(
        self, request: HttpRequest, multivaluedict: QueryDict) -> QueryDict: ...

    def get_post_parameters(
        self, request: Optional[HttpRequest]) -> MutableMapping[str, Any]: ...
    def cleanse_special_types(
        self, request: Optional[HttpRequest], value: Any) -> Any: ...
...
def technical_404_response(
    request: HttpRequest, exception: Http404) -> HttpResponse: ...
