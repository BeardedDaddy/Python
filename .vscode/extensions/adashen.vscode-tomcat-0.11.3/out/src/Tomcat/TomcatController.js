    ...
    dispose() {
        this._tomcatModel.getServerSet().forEach((element) => {
            if (element.isStarted()) {
                this.stopOrRestartServer(vscode_extension_telemetry_wrapper_1.createUuid(), element);
            }
    ...
    startTomcat(operationId, serverInfo) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                vscode_extension_telemetry_wrapper_1.sendOperationError(operationId, 'startTomcat', err);
