...
class PreviewManager {
    ...
    dispose() {
        ...
        this.reporter.sendFinishedEvent(settings_1.settings()).finally(() => {
    ...
    startAndBindPython() {
        return __awaiter(this, void 0, void 0, function* () {
            const pythonPath = yield areplUtilities_1.default.getPythonPath();
            ...
            this.PythonEvaluator.pyshell.on("error", (err) => {
