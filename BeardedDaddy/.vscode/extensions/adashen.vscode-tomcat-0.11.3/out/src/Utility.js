...
(function (Utility) {
    ...
    function trackTelemetryStep(operationId, step, callback) {
        return vscode_extension_telemetry_wrapper_1.instrumentOperationStep(operationId, step, callback)();
    }
    Utility.trackTelemetryStep = trackTelemetryStep;
    function infoTelemetryStep(operationId, step) {
        vscode_extension_telemetry_wrapper_1.sendInfo(operationId, { finishedStep: step });
    }
