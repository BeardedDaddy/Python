...
function activate(context) {
    ...
    statusBarItem.text = config_1.default.appTitle;
...
function createWebviewPanel(context) {
    ...
    _panel = vscode.window.createWebviewPanel('gitkraken-glo', config_1.default.appTitle, vscode.ViewColumn.Active, {
        enableScripts: true,
...
function getWebviewContent() {
    ...
    return `
        ...
        <head>
            <meta charset="utf-8">
            <title>${config_1.default.appTitle}</title>
            <style>
                body {
                    padding: 0;
                    margin: 0;
