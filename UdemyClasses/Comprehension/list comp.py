"""
This script prompts the user to enter a number. It then squares each number in
a predefined list,
and prints the square of the number entered by the user.

The script uses a list comprehension to square each number in the list, and
the `index` method to find the position
