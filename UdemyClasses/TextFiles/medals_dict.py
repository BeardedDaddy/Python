...
"""This function will pass to the dictionaries that need to be sorted.\
...
# Here we are providing the name of the function \
# and the sorted function will call it when it needs it.
