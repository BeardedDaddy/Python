    ...
    with open("albums.txt", "r") as albums:
        for line in albums:
            ...
            if new_album is None:
                ...
                # Store the current in the artist collection then create a new ablum object.
                new_artist.add_album(new_album)
                new_album = Album(album_field, year_field, new_artist)
        ...
        # After read the last line of the text file, 
        # we will have an artist and album that haven't been store = process them now
